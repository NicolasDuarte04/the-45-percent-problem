# Muller Athletic Press Packet (data extracts only; not the email)
...
| File | Purpose | sha256 |
|---|---|---|
| `draft_column.md` |  | `bf75b7e216859c41e546babbf4ec4dedb7e3dd79b17ab227f336ebaaed1c1760` |
| `usa_path_conditional.csv` | USA conditional opponent probabilities by round | `486334944a9f51af2410db5e7ff5588e8806a145aab6f47d2c41d367d1f24d97` |
| `usa_path_probabilities.csv` | USA path probabilities (group + knockout marginals) | `c1304567461397f65f780174decc70d49093db0feb95fad28f2422fa17cea927` |
