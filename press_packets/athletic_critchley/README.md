# Critchley Athletic Press Packet (data extracts only; not the email)
...
| File | Purpose | sha256 |
|---|---|---|
| `argentina_path_probabilities.csv` | Argentina path probabilities (group + knockout marginals) | `01d757c6505153521904b0269e0755154cc72730e0ec79e06accac6c27d1b612` |
| `defender_winrate_history.csv` | Hand-curated 1962 to 2022 defender outcomes | `54babed077ae5051e8a4953d826b64fef609d0e93a05beead244356a5a7f3d39` |
| `draft_column.md` |  | `027fd2ed7e7b8b8ceb6ba39fb52d79e78ecc0dd26f0865e9df728773bd2c8631` |

## Pending files (Section 6 dependency)

- `argentina_market_divergence.csv`: BLOCKED on real Pinnacle data ingestion. The pipeline is structurally ready; verification in Section 6 of LOCKDOWN_PLAN. Once Pinnacle publishes 2026 lines, this file becomes auto-generable.
