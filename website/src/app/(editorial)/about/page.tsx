    ...
    >
      ...
      >
        ...
        >
          ...
          publishes every night the current state of the M&#9733; probability
          distribution, its divergence from market-implied probabilities, and
          an append-only record of every forecast the model has ever made.
        </p>
