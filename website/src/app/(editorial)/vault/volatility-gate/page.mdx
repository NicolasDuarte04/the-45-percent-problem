...
* **[Pre-registration](/vault/preregistration)**: the OSF DOI, the annotated Git tag, and the sealed `pre_reg_constants.yaml` that locks every threshold on this page.
